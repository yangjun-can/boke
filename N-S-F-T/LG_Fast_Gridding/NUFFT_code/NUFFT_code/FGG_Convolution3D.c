...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
     ...
     */
    /*Declarations*/
    mxArray *fpointr;/*The pointer to the real components of the
    frequency-domain data*/
    mxArray *fpointi;/*The pointer to the imaginary components of the
    frequency-domain data*/
    double *fr, *fi;/*The real and imaginary components of the
    frequency-domain data*/
    ...
    M =  mxGetM(fpointr);/*number of data points*/
    /*Get matrix knots*/
    ...
    plhs[0] = mxCreateDoubleMatrix(N3, 1, mxREAL);/*mxReal is our data-type*/
    plhs[1] = mxCreateDoubleMatrix(N3, 1, mxREAL);/*mxReal is our data-type*/
        ...
        {   
            ...
            {   
                ...
                {   
                    ...
                    outArrayR[ind]+= V1r*E_23x;
                    outArrayI[ind]+= V1i*E_23x;
                }
            }
        }
    }
