function [Omega,A] =MARS_SFT_nonoise(Sig, Win, N0, N1, T)                     
% FPS_SFT, set Win as rect window, epsilon =1e-10
...
function [Omega, A] = SFT_INNER_nonoise(Sig, Win, Omega1, A1, N0, N1, epsilon, gamma)
% 随机切片估计无躁的频率
% Input:
%   Sig: singal matrix
%   Win: window matrix
...
%% 利用切片估计
[ind,ha] = triSlicing2(Sig, Win, Omega1, A1 ,alpha0, alpha1, tau0,tau1, epsilon, gamma,L);
